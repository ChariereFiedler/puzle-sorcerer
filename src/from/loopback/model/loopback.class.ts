...
namespace model.loopback {
    export class Class {
        ...
        constructor(name: string, plural: string, description: Array<string>, base: string, idInjection: boolean, forceId: boolean, httpPath: string, strict: boolean, options: Object, properties: Array<model.loopback.Property>, relations: Object, acls: Array<any>, scopes: Object) {
            this._name = name;
            this._plural = plural;
        ...
        get properties(): Array<model.loopback.Property> {
            return this._properties;
        }

        set properties(value: Array<model.loopback.Property>) {
